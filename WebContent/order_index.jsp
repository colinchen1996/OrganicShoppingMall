	...
	$(function(){
		...
		<%for(int i=0;i<productList.size();i++){%>
			var $Newclone = $clone.clone(true);
				...
				var $totle = <%=countList.get(i)%> * <%=productList.get(i).getProductPrice()%>
...
<div class="border_top_cart">
                            ...
                            <div class="box-bd">
                                ...
                                <div class="checkout-count clearfix">
                                    ...
                                    <div class="checkout-price">
                                        ...
                                        <p class="checkout-total">应付总额：<span><strong id="totalPrice">39</strong>元</span></p>
                                    </div>
                                    <!--  -->
                                </div>
                            </div>
    ...
    <script src="js/jquery/order_base.min.js"></script>
