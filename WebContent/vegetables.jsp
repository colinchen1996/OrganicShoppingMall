...
<%
	List<Product> list = (List) request.getAttribute("vegetablesList");
%>
</head>
<body>
						...
						<div class="row">
							...
							<div class="col-sm-6 col-md-4 col-lg-3">
								...
								<div class="product-item">
									<a href="Product_detail_Servlet?idd=<%
									...
									<div class="product-caption">
										...
										<div class="product-price-group">
											<span class="product-price"><% out.print("$"+list.get(i).getProductPrice()); %></span>
										</div>
