...
<%@page import="org.lanqiao.entity.ProductImgInfo"%>
<%@page import="java.util.*"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	List<Product> list = (List) request.getAttribute("productsList");
	List<Product> list1 = (List) request.getAttribute("productsList1");
	List<ProductImgInfo> list2 = (List)request.getAttribute("productImgInfoList");
	List<Product> list3 = (List) request.getAttribute("productsList3");
%>
...
<link rel="stylesheet" type="text/css" href="css/fw.css" media="screen">
    ...
    $(function(){ 
        ...
        $('.into').click(function(){  //加入购物车
			alert("添加成功")	
			$.post("AddCartServlet",{"productId":$(this).next().prop("title"),
				...
				<div class="product-pare m-t-xs-60">
					...
					<p class="product-price">
						...
						<div class="name41" style="padding-bottom: 20px">
							...
							<input type="text" value="1" name="num" class="text" readonly="readonly" style="width: 50px; text-align: center; " > 
		...
		<div class="row product-bor">
			<div class="owl" data-items="4" data-itemsDesktop="3"
				...
				<div class="col-lg-12">
					<!-- Product item -->
					<div class="product-item">
						<a href="Product_detail_Servlet?idd=<%out.print(list3.get(i).getProductId());%>"> <img
