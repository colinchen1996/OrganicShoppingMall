<%@page import="org.lanqiao.entity.ProductItem"%>
<%@page import="org.lanqiao.entity.Product"%>
<%@page import="org.lanqiao.entity.OrderItem"%>
<%@page import="org.lanqiao.entity.Order"%>
<%@page import="org.lanqiao.entity.Address"%>
				...
				<ul class="top-link pull-right">
					...
					<li class="pull-right">
						<div class="cart dropdown">
							<a href="CartServlet" class="cart-item dropdown-toggle" > <span class="totlecount">0</span>
			...
			<div id="yin_middle">
				<div id="yin_middle_top">
				 ...
				 <div id="yin_middle_active1">			
					...
					<div>
						<%
							ArrayList<User> users = (ArrayList<User>) request.getSession().getAttribute("list");
					...
					<form action="updateUserInfoServlet" method="post">
						<ul id="yin_middle_middle_ul1">
							<li class="yin_middle_middle_li"><span
								...
								id="yin_name" name="name" class="yin_middle_middle_li2"
								value="<%out.print(users.get(0).getUserName());%>" readonly style="border: 0px"></li>
							<li class="yin_middle_middle_li"><span class="yin_middle_middle_li1">邮箱：</span><input type="text"
								
								id="yin_email" name="email" class="yin_middle_middle_li2"
								value="<%out.print(users.get(0).getEmail());%>"></li>
							<li class="yin_middle_middle_li"><spam
									class="yin_middle_middle_li1">电话：</spam> <input type="text"
								id="yin_tel" name="phoneNumeber" class="yin_middle_middle_li2"
								value="<%out.print(users.get(0).getPhoneNumber());%>"></li>
								<input type="submit" class="yin_middle_middle_li1" id="yin_middle_middle_submit" value="确认更改个人信息">
						</ul>
						<div id="yin_middle_address">
							<%
								ArrayList<Address> addresslist = (ArrayList<Address>) request.getSession().getAttribute("addresslist");
							...
							<ol>
								...
								<div id="yin_middle_middle_address">
									...
									<textarea id="yin_address" class="yin_address" name="<% out.print(addresslist.get(i).getAddressId());%>"><%out.print(addresslist.get(i).getProvince());
								...
								<a class="yin_delete" href="deleteUserInfoAddressServlet?AddressId=<%=n%>">删除</a>
				...
				ArrayList<Object> orderItemlist = (ArrayList<Object>) request.getSession().getAttribute("list3");
					...
					for(int m=0;m<orderlist.size();m++)
					{
						...
						String orderStatus = orderlist.get(m).getOrderStatus();
						
						ArrayList<Address> addressList2 = (ArrayList)addlist.get(m);
						...
						ArrayList<Product> productlist = (ArrayList)prolist.get(m);
				...
				%>	
                    ...
                    <tr class="active2_table_tr">
                        <td style="width: 130px" rowspan=<%=size %>><%=orderId %></td>
                        <td style="width: 150px" rowspan=<%=size %>><%=orderDate %></td>
                        <td style="width: 80px"><%=productName %></td>
                        <td style="width: 80px"><%=productcount %></td>
                        <td style="width: 80px"><img src="images/<%=defaultImg %>" style="width: 30px;height: 25px"></td>
                        <td style="width: 410px" rowspan=<%=size %>><%=address %></td>
                        <td style="width: 130px" rowspan=<%=size %>><%=price %></td>
                    	<td style="width: 80px"  rowspan=<%=size %>><%=orderStatus %></td>
                    </tr>  
                    ...
                    <tr class="active2_table_tr">
                        ...
                        <td style="width: 110px"><img src="images/<%out.print(productlist.get(i).getDefaultImg());%>" style="width: 30px;height: 25px"></td>
                    </tr>
                   <%} %>
                	 </table>
                	 <%} %>
